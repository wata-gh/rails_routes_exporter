...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Rails route exporter for mpdev-console}
  spec.description   = %q{Rails route exporter for mpdev-console}
  spec.homepage      = "https://ghe.ckpd.co/adtech/rails_routes_exporter"
  spec.license       = "MIT"
